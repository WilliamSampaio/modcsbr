...
- Armas coletadas do chão são exceção ao HUD exato imediato: a munição do carregador inserido aparece como desconhecida até o jogador concluir a ação check magazine ou recarregar a arma. Check magazine apenas revela o valor autoritativo do servidor; não concede munição nem altera o estado da arma.
