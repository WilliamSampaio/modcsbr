...
- Added a backlog technical spec for local `.downloads/` cache, optional community map installation into the generated runtime, and future Xash3D FWGS download/update handling with fixed versions and hashes.
