...
- Fixed operational-side swaps at halftime for reversible scenarios and allowed community scenarios to select normal or suppressed pistol profiles for Marksman only, provided the same mechanical profile is applied to both teams.
